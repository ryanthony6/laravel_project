@foreach ($schedules as $schedule)
    <div class="modal fade" id="createScheduleModal{{ $schedule->id }}" tabindex="-1"
        aria-labelledby="createScheduleModalLabel{{ $schedule->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createScheduleModalLabel{{ $schedule->id }}">Tambah Jadwal</h5>
