@unless (Route::is('login') || Route::is('register') || Route::is('password.request') || Route::is('profile.index'))
    ...
    <footer class="py-3 shadow-xl" id="footer">
        ...
        <div class="py-6 py-md-8 py-xl-10">
            <div class="container">
                <div class="row gy-3">
                    <div class="col-12">
                        <div class="footer-logo-wrapper text-center pt-2">
                            {{-- <a href="#!">
                                <img src="./assets/img/bsb-logo.svg" alt="BootstrapBrain Logo" width="153" height="50">
                            </a> --}}<h3 class="text-white"> Cahaya Sports <h3>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div>
            <div class="container">
                <div class="row gy-3 gy-sm-0 align-items-sm-center">
                    <div class="col-sm-6">
                        <div class="copyright-wrapper d-block mb-1 fs-9 text-center text-sm-start text-white">
                            &copy; 2024. All Rights Reserved.
                        </div>
                        <div class="credit-wrapper d-block text-secondary fs-10 text-center text-sm-start text-white">
                            Made with <span class="text-love">&#9829;</span>
                        </div>
                    </div>
                    <div class="col-sm-6">
